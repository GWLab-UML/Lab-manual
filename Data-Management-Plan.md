...
- environmental data (temp, salinity, turbidity, etc.)
...
### Long-term projects
Long-term projects need to include two types of trackers: 
1. **meta tracker**: keeps track of when and what types of data has been collected, uploaded, and processed
	- purpose: in a snapshot, what data do we have? 
	- ex. of info stored here: for field work in MM/YY, we have photo quadrants, videos, and shell weight data and missing orion data
2. **data tracker**: keeps track of data at a higher resolution (or is the data itself)
	- ex: photo quadrat tracker includes progress and status on whether the data us been uploaded, downloaded, processed as well as where files/samples can be found
...
### Unity `/project` 
Raw sequences should be compressed with tar.zip and stored in the Raw_sequences folder on Unity.
